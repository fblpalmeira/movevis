...
animate_frames(frames, out_file = "jaguar_pantanal_saobento_2008_satellite.gif", width = 800, height = 550, res = 95)

library(magick)
library(magrittr) 

# Call back the plot
plot <- image_read("jaguar_pantanal_saobento_2008_satellite.gif")
plot2<-image_annotate(plot, "Image credit: @PhyloPic (Palmeira, FBL and Trinca, CT)", 
                      color = "gray", size = 12, 
...
image_write(out, "jaguar_pantanal_saobento_sattelite2.gif")
